...
import { getManufacturers, updateManufacturer } from '@/api/lookups'
import type { ManufacturerItem } from '@/types'
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-6 space-y-8">
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
          <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
            <div>
              <h2 className="text-base font-semibold text-gray-900 dark:text-white">Manufacturers</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                {manufacturers.length} entries — click the pencil icon to edit a name or URL
              </p>
            </div>
          </div>
