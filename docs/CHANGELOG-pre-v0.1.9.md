# AmmoLedger Changelog (Pre-v0.1.9 Archive)

This file is a **frozen archive** of all changelog entries from v0.1.0
through v0.1.8, plus the unreleased work that was on `dev` at the time
of the v0.1.9 migration squash. It is no longer updated.

For the active changelog from v0.1.9 onward, see [CHANGELOG.md](../CHANGELOG.md).
For the rationale behind the squash, see [HISTORY.md](./HISTORY.md).
...
## Pre-v0.1.9 Unreleased Work

The features and fixes that were on `dev` at the time of the v0.1.9 squash
are documented in the [active CHANGELOG](../CHANGELOG.md) under the
`[0.1.9]` entry. They are preserved below for completeness.
