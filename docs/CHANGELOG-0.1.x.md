# AmmoLedger Changelog — 0.1.x Archive

This file is a **frozen archive** of all changelog entries from v0.1.0
through v0.1.9. It is no longer updated.

For the active changelog from v0.2.0 onward, see [CHANGELOG.md](../CHANGELOG.md).
For the rationale behind the v0.1.9 migration squash, see [HISTORY.md](./HISTORY.md).
